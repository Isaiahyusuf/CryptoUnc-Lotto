...
This document lists ALL environment variables used by the CryptoUnc Lotto Telegram Bot.
...
- **Example**: `@cryptounclottoportal` or `-1001234567890`
- **Default**: `@cryptounclottoportal`
...
- **Example**: `cryptounc_support` (without @)
